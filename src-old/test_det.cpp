...
int main() {
  ...
  auto makeDenseMatrix = [&](const string &name, int n,
  ...
  // 3×3 example: det([[6,1,1],[4,-2,5],[2,8,7]]) = 6(-2*7 - 5*8) - 1(4*7 - 5*2)
  // + 1(4*8 - (-2)*2) = 6(-14 - 40) - (28 - 10) + (32 + 4) = 6*(-54) - 18 + 36
  // = -324 - 18 + 36 = -306
  makeDenseMatrix("B", 3, {6, 1, 1, 4, -2, 5, 2, 8, 7});
  {
